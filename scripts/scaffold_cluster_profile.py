...
def _full_profile(profile_id: str, name: str) -> dict:
    ...
    profile.update({"description": "Fill only verified public provider information.",
        ...
        "access": {"hosts": [], "auth_methods": [], "access_note": "", "documentation_url": None},
        "requirements": {"project": {"required": False, "label": "Project", "help": ""},
                         "account": {"required": False, "label": "Account", "help": ""}},
