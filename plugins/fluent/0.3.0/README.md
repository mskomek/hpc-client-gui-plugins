...
## Job templates (new in 0.2.0)

- luent-slurm-basic — a generic headless Fluent Slurm batch script with
  placeholders (partition, CPUs, time limit, journal path). It intentionally
  contains **no cluster-specific defaults**; verify partition names and the
  Fluent executable/module setup for your site before submitting.
