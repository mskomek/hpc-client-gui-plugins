...
```bash
python scripts/scaffold_cluster_profile.py --plugin-id org.hpcclient.example --profile-id my-site --name "My Site" --version 0.1.0 --requires-app ">=1.5.4" --template minimal --output-dir staging/my-site/0.1.0
```
